package com.example.videorecorder.SimpleClasses;
...
public class Variables {
    ...
    public static final String app_folder = root + "/Wiggle/";
    ...
    public static final String base_url = main_domain + "API/tictic/";
    ...
    public static String tag = "Wiggle_";
