...
import com.example.videorecorder.SegmentProgress.ProgressBarListener;
import com.example.videorecorder.SegmentProgress.SegmentedProgressBar;
import com.example.videorecorder.SimpleClasses.FileUtils;
import com.example.videorecorder.SimpleClasses.Fragment_Callback;
import com.example.videorecorder.SimpleClasses.Functions;
import com.example.videorecorder.SimpleClasses.Variables;
import com.example.videorecorder.SoundLists.SoundList_Main_A;
import com.example.videorecorder.Video_Recording.GallerySelectedVideo.GallerySelectedVideo_A;
...
//    };
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(Video_Recoder_A.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(Video_Recoder_A.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(Video_Recoder_A.this, "Write External Storage permission allows us to do store images. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
            ActivityCompat.requestPermissions(Video_Recoder_A.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO,}, PERMISSION_REQUEST_CODE);
        }
    }
